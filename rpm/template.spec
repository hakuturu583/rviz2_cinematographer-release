...
Name:           ros-kilted-rviz2-cinematographer-video-recorder
Version:        0.2.0
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS rviz2_cinematographer_video_recorder package
...
%description
Subscribes to images rendered by the rviz2 cinematographer view controller and
generates a video.
