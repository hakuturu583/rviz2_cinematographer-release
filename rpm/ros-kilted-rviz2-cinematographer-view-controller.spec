...
Name:           ros-kilted-rviz2-cinematographer-view-controller
Version:        0.2.0
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS rviz2_cinematographer_view_controller package
...
%description
An rviz2 view controller featuring smooth transitions along camera trajectories
and frame-by-frame rendering for video recording.
